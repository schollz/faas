...
func TestParser(t *testing.T) {
	structString, err := FindFunction("https://github.com/schollz/ingredients", "NewFromString")
...
func TestFindFunction(t *testing.T) {
	...
	assert.Equal(t, []Param{Param{Name: "gitURL", Type: "string"}, Param{Name: "functionName", Type: "string"}}, inputParams)
